//
//  TableViewControllerNuevoTableViewController.swift
//  ChipanaTableViewController
//
//  Created by Mac 16 on 26/04/23.
//
...
class TableViewControllerNuevoTableViewController: UITableViewController {
    ...
    */
    ...
    override func tableView(_ tableView: UITableView, editActionsForRowAt indexPath: IndexPath) -> [UITableViewRowAction]? {
        let botonEliminar = UITableViewRowAction(style: .normal, title: "Eliminar") {(accionesFila, indiceFila)in self.arregloNumeros.remove(at: indexPath.row)
            tableView.reloadData()
        }
